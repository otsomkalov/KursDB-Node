...
module.exports.post=(req,res,next)=>{
    ...
    async.series([
            ...
            (callback)=>{
                client.query("SELECT id FROM employees WHERE passport=$1 OR email=$2 OR tel=$3 OR log=$4 OR ticket=$5",
                    [body.passport,body.log,body.tel,body.log,body.ticket],(err,result)=>{
                        if (err){
                            callback(err)
                        }
                        else{
            ...
            if (err){
                ...
                client.query("INSERT INTO employees VALUES('"+body.surname+"','"+body.name+"','"+body.patronymic+
                    "','"+body.birth+"','"+body.passport+"','"+body.ticket+"','"+body.address+
